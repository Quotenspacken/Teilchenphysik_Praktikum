...
axs[0].set_xlabel(r"$\lambda \,/\, \mathrm{nm}$")
axs[0].set_ylabel(r"Intensität ohne Dark Counts $\mathbin{/}$ Counts")
axs[0].legend()

axs[1].plot(lam, I_on, "b,", label="mit Raumlicht, ohne DC")
axs[1].set_xlabel(r"$\lambda \,/\, \mathrm{nm}$")
axs[1].set_ylabel(r"Intensität ohne Dark Counts $\mathbin{/}$ Counts")
axs[1].legend()
# Layout
plt.tight_layout(pad=0, h_pad=1.08, w_pad=1.08)
