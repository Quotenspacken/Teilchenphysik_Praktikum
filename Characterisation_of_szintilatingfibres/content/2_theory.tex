...
Er untersucht unter anderem Proton-Proton-Kollisionen, 
...
Die dafür benötigte Hauptspurenkammer ist der Scintillating Fibre Tracker (SciFi Tracker).
...
\begin{figure}[h]
	...
	\caption[Schematische Darstellung des LHCb Upgrade 2 Detektors.]{Schematische Darstellung eines Querschnittes des LHCb Upgrade 1 Detektors \cite{TDR}.}
	\label{fig:LHCb}
\end{figure}
...
Der \textit{Vertex-Locator} (VELO) dient der Identifizierung und Unterscheidung der primären und sekundären Vertices der Teilchen.
...
Er bedeckt eine Fläche von $340$ m$^2$ und besteht aus mehr als $10000$ km szintilierenden Fasern.
...
die jeweils 6m lang sind und eine Breite von 4,8m aufweisen.
...
So werden durch die Photonen Phononen angeregt und auch die Eigenabsorption durch die Wellenlängenverschieber führt zu einer Abnahme der Intensität.
...
In Abhängigkeit von der zurückgelegten Strecke $L$ durch die Faser und der Dämpfungslänge $\lambda$ kann die abnahme der Intensität beschrieben werden durch:
\begin{equation}
...
bei der typischerweise etwa ($10^6)$ Elektronen entstehen. 
Diese Ladungslawine führt zu einem messbaren Strompuls.

Damit das Pixel nach einem solchen Ereignis wieder reaktiv wird, 
...
Im Maximum liegt die PDE bei den hier verwendeten SiPMs bei etwa $43\%$.

Eine weitere wichtige Eigenschaft ist die Dunkelrate (dark count rate), 
welche ohne einfallendes Licht entsteht. 
