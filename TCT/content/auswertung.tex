...
Aufgrund des hohen Rauschens bei Bias-Spannungen von unter $100$ Volt  kommt es in diesem Bereich zu einem verfälschten Ergebnis, 
da die Integrationsgrenzen dadzurch nicht zuverlässig bestimmt werden können.
Zusätlich könnte es in diesem Spannungsbereich noch nicht zu einer vollständigen Depletion des Sensors gekommen sein,
was einen möglichen Grund für die Steigende Ladung bei Bias-Spannungen von unter $100$ Volt darstellen könnte. 
Der Grund ist das bei einem nicht vollständig depletierten Sensor die Ladungsträger nicht vollständig zur Elektrode getrieben werden und somit Ladungen verloren gehen.
\begin{figure}[htbp]
  \centering
  ...
  \caption{Gemittelte induzierte Ladung als Funktion der Bias-Spannung. Fehlerbalken geben die Standardabweichung über 1000 Events an.
            Der Anstig im Bereich unter $100$ Volt ist auf das hohe Rauschen und eine mögliche unvollständige Depletion des Sensors zurückzuführen.}
...
In \autoref{fig:charge_laser} ist der berechnete Ladung in Abhängigkeit der Laserintensität aufgetragen.
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[b]{0.49\textwidth}
    ...
    \caption{Rückseite}
  \end{subfigure}
  \caption{Gemittelte Signaldauer als Funktion der Laserintensitätsreduktion. Die Signaldauer zeigt keine signifikante Abhängigkeit von der Laserintensität. Die Abnehmenden Signaldauer bei der Rückseite ist auf das hohe Rauschen bei niedrigen Laserintensitäten zurückzuführen.}
...
Allerdings ist bei der Rückseite vergl\autoref{fig:sigtime_laser} eine  Abnahme der Signaldauer mit abnehmender Laserintensität zu beobachten.
Dies ist auf das hohe Rauschen der Rückseite bei niedrigen Laserintensitäten zurückzuführen.
