...
A feature selection is used to find the optimal features.
...
For each fold, the Punzi significance reaches its maximum at a BDT output
threshold close to $0.99$.
\begin{figure}
    \centering              
    ...
    \label{fig:FOM}
\end{figure}
The average optimal threshold of the five folds
is therefore approximately $0.99$.
